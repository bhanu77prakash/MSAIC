...
def preprocess(tr_dat):
    df = pd.read_csv("./data/"+tr_dat, sep="\t", header=None)   # read dummy .tsv file into memory
    ...
    embed_char_path = "./data/glove.6B.100d-char.txt"
    embed_word_path = "./data/glove.6B.100d.txt"
    ...
    np.savetxt("./data/preprocessed_train_pasges("+tr_dat+").npy", pasges)
    np.savetxt("./data/preprocessed_train_queries("+tr_dat+").npy", queries)
    np.savetxt("./data/preprocessed_test_queries("+tr_dat+").npy", test_queries)
    np.savetxt("./data/preprocessed_test_pasges("+tr_dat+").npy", test_pasges)
    np.savetxt("./data/embed_word_matrix("+tr_dat+").npy", embed_word_matrix)
    np.savetxt("./data/embed_char_matrix("+tr_dat+").npy", embed_char_matrix)
    labels = train_data[:, 3]
    np.savetxt("./data/labels("+tr_dat+").npy", labels)
